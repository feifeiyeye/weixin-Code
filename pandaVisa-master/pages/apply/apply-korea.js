...
Page({
  data: {
    ...
    heights: [611, 407, 503, 152, 252],  // 这里的高度都是基本高度，在有选项展开后，要加上相应的展开的高度
    // +16是因为判决有罪换行
    //出生日期
    dateNow: '', // 当前日期字符串
  ...
  validfamilyAndWork: function (showToast) {
    var inputStatus = this.data.inputStatus
    inputStatus[2] = 1
  ...
  // 校验紧急联系人
  validUgentInfo: function (showToast) {
    var inputStatus = this.data.inputStatus
    inputStatus[3] = 1
